...
then
    ...
    if [ "${nmol}" -gt 0 ]
    then
        echo 'Initialize a configuation of '$nmol ' molecules in a box of size: '  ${water_box_length} ${boxy} ${water_box_height}
        ${GMXpath}gmx insert-molecules -ci  ${pdbfile}.pdb -o init_n${nmol}_l${boxlength}_${system}${realizname}.gro -nmol $nmol  -box  ${water_box_length} ${boxy} ${water_box_height}
        echo 'Solvate a box of size: ' ${water_box_length} ${boxy} ${water_box_height}
        ${GMXpath}gmx solvate -cp init_n${nmol}_l${boxlength}_${system}${realizname}.gro -p topol_n${nmol}_l${boxlength}${realizname}.top -o init_n${nmol}_l${boxlength}_${system}${realizname}.gro  -box  ${water_box_length}  ${boxy} ${water_box_height}
    else
        echo 'Solvate a box of size: ' ${water_box_length} ${boxy} ${water_box_height}
        ${GMXpath}gmx solvate -p topol_n${nmol}_l${boxlength}${realizname}.top -o init_n${nmol}_l${boxlength}_${system}${realizname}.gro  -box  ${water_box_length}  ${boxy} ${water_box_height}
    fi
